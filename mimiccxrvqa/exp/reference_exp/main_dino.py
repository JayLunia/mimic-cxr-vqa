...
def get_args_parser():
    ...
    parser.add_argument(
        ...
        default="vit_small",
        type=str,
        choices=["vit_tiny", "vit_small", "vit_base", "xcit", "deit_tiny", "deit_small"] + torchvision_archs + torch.hub.list("facebookresearch/xcit"),
...
def train_dino(args):
    ...
    # if the network is a XCiT
        ...
        student = torch.hub.load("facebookresearch/xcit", args.arch, pretrained=False, drop_path_rate=args.drop_path_rate)
